...
namespace YoYo
{
    public partial class MacListenerWindow : AppKit.NSDocument
    {
        // Called when created from unmanaged code
        public MacListenerWindow(IntPtr handle) : base(handle)
        {
        }

        // Called when created directly from a XIB file
        [Export("initWithCoder:")]
        public MacListenerWindow(NSCoder coder) : base(coder)
        {
        }
